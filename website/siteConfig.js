...
const siteConfig = {
  title: 'Zent Cash Docs', // Title for your website.
  tagline: 'Documentation for all things Zent Cash',
  url: 'https://docs.zent.cash', // Your website URL
  ...
  headerLinks: [
    ...
    {doc: 'about/About-Zent-Cash', label: 'About'},
  ...
  headerIcon: 'img/zentcash_logo.svg',
  ...
  copyright1: `Copyright © ${new Date().getFullYear()} Zent Cash`,
  copyright2: `Docs released under the`,
  copyright3: `Zent Cash released under the`,
  ...
  editUrl: "https://github.com/ZentCashFoundation/zentcash-docs/edit/master/docs/",
