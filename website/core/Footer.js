...
class Footer extends React.Component {
  ...
  render() {
    const repoUrl = `https://github.com/ZentCashFoundation/zentcash-docs`
    return (
      <footer className="nav-footer" id="footer">
        <section className="sitemap">
          ...
          <div>
            <h5>Community</h5>
            <a href="https://discordapp.com/invite/9s7jWXF">Discord Chat</a>
            <a href="https://reddit.com/r/ZentCash/">Reddit</a>
            <a
              href="https://twitter.com/ZentCash"
              target="_blank"
          ...
          <div>
            <h5>More</h5>
            <a href="https://discordapp.com/invite/9s7jWXF">Blog</a>
            <a href="https://github.com/ZentCashFoundation">GitHub</a>
            <a
