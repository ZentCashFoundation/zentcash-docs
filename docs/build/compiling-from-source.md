...
-   `cd ..`
-   `git clone https://github.com/ZentCashFoundation/Zent/`
-   `mkdir -p Zent/build`
-   `cd Zent/build`
-   `cmake3 ..`
-   `make`
...
-   `MSBuild ZentCash.sln /p:Configuration=Release /p:PlatformToolset=v141 /m` or `MSBuild src\cli.vcxproj /p:Configuration=Release /p:PlatformToolset=v141 /m`
...
-   `MSBuild ZentCash.sln /p:Configuration=Release /p:Platform=Win32 /p:PlatformToolset=v141 /m`
